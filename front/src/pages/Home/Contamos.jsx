        ...
        <div className="bg-[#f2f2f2] rounded-lg border border-[#DA1641] shadow-md md:min-h-[550px] w-full">
          ...
          <div className="p-2">
            <p className="font-Roboto text-base text-center">
              En nuestra plataforma contamos con entrenadores altamente
              calificados, dedicados a guiar y motivar a nuestros clientes hacia
              el logro de sus metas fitness.
            </p>
          </div>
        </div>
        <div className="bg-[#f2f2f2] rounded-lg border border-[#DA1641] shadow-md md:min-h-[550px] w-full">
          ...
          <div className="p-2">
            <p className="font-Roboto text-base text-center">
              En nuestra plataforma contamos con terapeutas comprometidos con tu
              bienestar emocional y mental. Los mismos están capacitados para
              proporcionar apoyo y orientación en momentos difíciles, ayudándote
              a encontrar el equilibrio necesario para una vida plena.
            </p>
          </div>
        </div>
        <div className="bg-[#f2f2f2] rounded-lg border border-[#DA1641] shadow-md md:min-h-[550px] w-full">
          ...
          <div className="p-2">
            <p className="font-Roboto text-base text-center">
              En nuestra plataforma contamos con nutricionistas especializados
              que te brindarán asesoramiento personalizado. Entendemos que la
              alimentación es clave para alcanzar un estilo de vida saludable,
              Los mismos están aquí para diseñar planes alimenticios adaptados a
