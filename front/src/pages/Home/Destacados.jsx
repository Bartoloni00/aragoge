      ...
      <div className="gap-[40px] mx-auto flex flex-col items-center md:flex-row px-4 md:px-2 text-center">
        <div className="bg-[#f2f2f2] rounded-lg border shadow-md w-full">
          <div className="flex flex-col justify-center items-center">
            <img
              src="../../../public/img/destacado-1.webp"
              alt="Imagen del Profesional destacado William Jame"
              width={480}
              height={270}
              loading="lazy"
            />
        ...
        <div className="bg-[#f2f2f2] rounded-lg border shadow-md w-full">
          <div className="flex flex-col justify-center items-center">
            <img
              src="../../../public/img/destacado-2.webp"
              alt="Imagen del Profesional destacado Barry Jay"
              width={480}
              height={270}
              loading="lazy"
            />
        ...
        <div className="bg-[#f2f2f2] rounded-lg border shadow-md w-full">
          <div className="flex flex-col justify-center items-center">
            <img
              src="../../../public/img/destacado-1.webp"
              alt="Imagen de la Profesional destacada Viviana Lacher"
              width={480}
              height={270}
              loading="lazy"
            />
