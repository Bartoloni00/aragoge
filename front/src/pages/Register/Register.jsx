  ...
  const onChangeEmail = useCallback(
    (e) => {
      if (e.target.value.trim() !== "") {
        ...
        setError("El mail no puede estar vacío");
      }
          ...
          <div className="w-full max-w-md bg-[#f2f2f2] p-6 rounded-lg">
            ...
            >
              ...
              <div className="flex flex-col my-5">
                <label htmlFor="name" className="text-sm font-Roboto">
                  Nombre:
                </label>
              ...
              <div className="flex flex-col my-5">
                <label htmlFor="lastname" className="text-sm font-Roboto">
                  Apellido:
                </label>
                <div className="flex flex-row items-center">
                  <span className="bg-white p-2 rounded-s-lg shadow-md">
              ...
              {/* Rol del usuario */}
              <div className="flex flex-col my-5">
                <label htmlFor="rol" className="text-sm font-Roboto">
                  Rol:
                </label>
                <div className="flex flex-row items-center">
                  <span className="bg-white p-2 rounded-s-lg shadow-md">
              ...
              <div className="flex flex-col my-5">
                ...
                <div className="flex flex-row items-center mt-2">
                  <img
                    src={
                      image.src ? image.src : "../../public/img/default.webp"
                    }
                  ...
                  <input
                    ...
                    className="bg-white p-[7px] mx-[2px] shadow-md w-full file:bg-white file:border-none file text-transparent cursor-pointer"
                  />
                </div>
              </div>
